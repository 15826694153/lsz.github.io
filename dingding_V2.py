...
def isAwaked(deviceid=''):  # 判断屏幕亮屏状态
    '''
    判断的依据是'    mAwake=false\n'
    '''
    if deviceid == '':
...
if isAwaked() == True:
    ...
    print('屏幕已灭屏。')
    os.system("adb shell input keyevent 26")   # 电源键
...
#time.sleep(0.5)
#os.system("adb shell input text 978162")  # 解锁
time.sleep(0.5)
...
# 删除设备截屏
os.system("adb shell rm -r /sdcard/DCIM/Screenshots/ding.png")
...
path = 'E:/study2/python/ding.png'  # 文件路径
